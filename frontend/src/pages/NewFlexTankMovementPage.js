...
export default function NewFlexTankMovementPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await api.createFlexTankMovement({
  ...
  return (
    <Layout>
      <div className="max-w-4xl mx-auto" data-testid="new-flex-tank-movement-page">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-muted-foreground mt-1">Registre uma entrada ou saída de bolsa Flex Tank</p>
          </div>
        </div>
